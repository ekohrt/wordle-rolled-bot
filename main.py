...
rules = {
    ...
    "lip_noun": ["lip", "lip", "liver", "lint", 'lard', "ligament", "libertarian", "ligma", "librarian", 
                 ...
                 "limb", "lid", "litter", "lettuce", "laundry", "laser", "quiver"],
    "lip_adj": ["limp", "limp", "linear", "lithospheric", "liquidy", "limber",
                "lippy", "limy", "lit", "literal", "little", "lanky", "loopy", "quick"],
    "lip_verb_ing": ["licking", "licking", "lipping", "flicking", "listing", "loving"],
